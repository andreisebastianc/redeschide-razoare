            ...
            <div className="relative mx-auto max-w-5xl pt-16 sm:px-6">
                <div className="bg-slate-50 pt-px sm:rounded-6xl">
                    <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
                        ...
                        <p className="mt-4 text-xl tracking-tight text-slate-700">
                            Neavând transport în comun în aceasta zonă cetățenii sunt obligați să stea în coloană de mașini sau
                            să se deplaseze pe jos, pe un drum fara trotuar, străbătut dimineața și seara, de mii de mașini pe
                            oră.
                        </p>
                        <p className="mt-4 text-xl tracking-tight text-slate-700">
                            Primăria Florești recunoaște public insuficiența numărului de autobuze și suplimentează mijloacele
                            de transport în comun pentru anumite zone.
                        </p>
                        <p className="mt-4 text-xl tracking-tight text-slate-700">
                            Noi credem ca Primăria Florești trebuie să desființeze acest sens unic, cel puțin pană la momentul
